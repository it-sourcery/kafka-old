...
public class MemoryRecordsTest {
    ...
    public void testIterator() {
        ...
        for (int i = 0; i < list.size(); i++) {
            Record r = list.get(i);
            recs1.append(i, r);
            recs2.append(i, 0L, toArray(r.key()), toArray(r.header()), toArray(r.value()));
        }
        recs1.close();
        recs2.close();
    ...
    public void testHasRoomForMethod() {
        ...
        assertTrue(recs1.hasRoomFor("b".getBytes(), null, "2".getBytes()));
        recs1.close();
        assertFalse(recs1.hasRoomFor("b".getBytes(), null, "2".getBytes()));
