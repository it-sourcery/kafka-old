 ...
 */
public class HeaderConsumerRecord<K, H, V> {
     ...
     */
    public HeaderConsumerRecord(String topic,
                                int partition,
                                long offset,
                                K key,
                                V value) {
    ...
    public HeaderConsumerRecord(String topic,
                                ...
                                V value) {
        this(topic, partition, offset, NO_TIMESTAMP, TimestampType.NO_TIMESTAMP_TYPE,
             NULL_CHECKSUM, NULL_SIZE, NULL_SIZE, NULL_SIZE, key, header, value);
    }
    ...
    public HeaderConsumerRecord(String topic,
            ...
            this(topic, partition, offset, timestamp, timestampType,
                 checksum, serializedKeySize, NULL_SIZE, serializedValueSize, key, null, value);
    }
     ...
     * @param serializedValueSize The length of the serialized value
     * @param key The key of the record, if one exists (null is allowed)
     * @param header The header of the record, if one exists (null is allowed)
     * @param value The record contents
     */
    public HeaderConsumerRecord(String topic,
                                int partition,
    ...
    /**
     * The header (or null if no header is specified)
     */
    public H header() {
        return header;
    }
    ...
    public String toString() {
        return "HeaderConsumerRecord(topic = " + topic() + ", partition = " + partition() + ", offset = " + offset()
               + ", " + timestampType + " = " + timestamp + ", checksum = " + checksum
               + ", serialized key size = "  + serializedKeySize
               + ", serialized header size = "  + serializedHeaderSize
