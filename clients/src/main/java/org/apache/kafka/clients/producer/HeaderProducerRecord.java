 ...
 * {@link RecordMetadata}
 */
public class HeaderProducerRecord<K, H, V> {
     ...
     * @param header The header that will be included in the record
     * @param value The record contents
     */
    public HeaderProducerRecord(String topic, Integer partition, Long timestamp, K key, H header, V value) {
        if (topic == null)
     ...
     * @param value The record contents
     */
    public HeaderProducerRecord(String topic, K key, H header, V value) {
        this(topic, null, null, key, header, value);
    }
     ...
     * @param value The record contents
     */
    public HeaderProducerRecord(String topic, K key, V value) {
    ...
    /**
     * @return The header (or null if no header is specified)
     */
    public H header() {
        return header;
    }
    ...
    public String toString() {
        ...
        String header = this.key == null ? "null" : this.header.toString();
        String value = this.value == null ? "null" : this.value.toString();
        String timestamp = this.timestamp == null ? "null" : this.timestamp.toString();
        return "HeaderProducerRecord(topic=" + topic + ", partition=" + partition + ", key=" + key + ", header=" + header + ", value=" + value +
            ", timestamp=" + timestamp + ")";
    }
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        else if (!(o instanceof HeaderProducerRecord))
            return false;

        HeaderProducerRecord<?, ?, ?> that = (HeaderProducerRecord<?, ?, ?>) o;

        if (key != null ? !key.equals(that.key) : that.key != null) 
            return false;
        else if (header != null ? !header.equals(that.header) : that.header != null)
            return false;
