...
public final class ProducerRecord<K, V> {
     ...
     */
    public ProducerRecord(String topic, Integer partition, Long timestamp, Map<Integer, byte[]> headers, K key, V value) {
        if (topic == null)
    ...
    /**
     * @return The headers (or null if no headers are specified)
     */
