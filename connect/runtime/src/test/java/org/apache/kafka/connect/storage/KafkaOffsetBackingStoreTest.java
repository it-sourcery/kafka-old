...
public class KafkaOffsetBackingStoreTest {
    ...
    @Mock
    KafkaBasedLog<byte[], Void, byte[]> storeLog;
    ...
    private Capture<Callback<HeaderConsumerRecord<byte[], Void, byte[]>>> capturedConsumedCallback = EasyMock.newCapture();
    ...
    public void testReloadOnStart() throws Exception {
        ...
        expectStart(Arrays.asList(
                new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 0, 0, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP0_KEY.array(), TP0_VALUE.array()),
                new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 1, 0, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP1_KEY.array(), TP1_VALUE.array()),
                new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 0, 1, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP0_KEY.array(), TP0_VALUE_NEW.array()),
                new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 1, 1, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP1_KEY.array(), TP1_VALUE_NEW.array())
        ));
        expectStop();
    ...
    public void testGetSet() throws Exception {
        ...
        PowerMock.expectLastCall().andAnswer(new IAnswer<Object>() {
            @Override
            public Object answer() throws Throwable {
                capturedConsumedCallback.getValue().onCompletion(null, new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 0, 0, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP0_KEY.array(), TP0_VALUE.array()));
                capturedConsumedCallback.getValue().onCompletion(null, new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 1, 0, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP1_KEY.array(), TP1_VALUE.array()));
        ...
        PowerMock.expectLastCall().andAnswer(new IAnswer<Object>() {
            @Override
            public Object answer() throws Throwable {
                capturedConsumedCallback.getValue().onCompletion(null, new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 0, 1, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP0_KEY.array(), TP0_VALUE_NEW.array()));
                capturedConsumedCallback.getValue().onCompletion(null, new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 1, 1, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP1_KEY.array(), TP1_VALUE_NEW.array()));
    ...
    public void testGetSetNull() throws Exception {
        ...
        PowerMock.expectLastCall().andAnswer(new IAnswer<Object>() {
            @Override
            public Object answer() throws Throwable {
                capturedConsumedCallback.getValue().onCompletion(null, new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 0, 0, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, (byte[]) null, TP0_VALUE.array()));
                capturedConsumedCallback.getValue().onCompletion(null, new HeaderConsumerRecord<byte[], Void, byte[]>(TOPIC, 1, 0, 0L, TimestampType.CREATE_TIME, 0L, 0, 0, TP1_KEY.array(), (byte[]) null));
                secondGetReadToEndCallback.getValue().onCompletion(null, null);
                return null;
            }
        });
    ...
    private void expectStart(final List<HeaderConsumerRecord<byte[], Void, byte[]>> preexistingRecords) throws Exception {
        storeLog.start();
        PowerMock.expectLastCall().andAnswer(new IAnswer<Object>() {
            @Override
            public Object answer() throws Throwable {
                for (HeaderConsumerRecord<byte[], Void, byte[]> rec : preexistingRecords)
