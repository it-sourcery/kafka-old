...
class ProducerFailureHandlingTest extends KafkaServerTestHarness {
  ...
  def testTooLargeRecordWithAckZero() {
    ...
    val record = new HeaderProducerRecord[Array[Byte],Array[Byte]](topic1, null, "key".getBytes, new Array[Byte](serverMessageMaxBytes + 1))
  ...
  def testNonExistentTopic() {
    ...
    val record = new HeaderProducerRecord[Array[Byte],Array[Byte]](topic2, null, "key".getBytes, "value".getBytes)
    intercept[ExecutionException] {
  ...
  def testWrongBrokerList() {
    ...
    val record = new HeaderProducerRecord[Array[Byte],Array[Byte]](topic1, null, "key".getBytes, "value".getBytes)
    intercept[ExecutionException] {
  ...
  def testInvalidPartition() {
    ...
    val record = new HeaderProducerRecord[Array[Byte],Array[Byte]](topic1, new Integer(1), "key".getBytes, "value".getBytes)
  ...
  def testCannotSendToInternalTopic() {
    val thrown = intercept[ExecutionException] {
      producer2.send(new HeaderProducerRecord[Array[Byte],Array[Byte]](Topic.InternalTopics.head, "test".getBytes, "test".getBytes)).get
    }
  ...
  def testNotEnoughReplicas() {
    ...
    val record = new HeaderProducerRecord[Array[Byte],Array[Byte]](topicName, null, "key".getBytes, "value".getBytes)
    try {
      producer3.send(record).get
